...
namespace pocketcloud\cloud\bridge\module\impl\sign\config;
...
final class SignLayoutConfig {
    ...
    public const array DEFAULT_LAYOUTS = [
        0 => [ //lobby
    ...
    public function __construct() {
        ...
        $this->config = new Config(CloudBridge::getInstance()->getDataFolder() .
            "signLayouts.yml", 2, self::DEFAULT_LAYOUTS);
    }
