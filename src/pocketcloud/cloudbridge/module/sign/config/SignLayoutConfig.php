...
namespace pocketcloud\cloudbridge\module\sign\config;
...
class SignLayoutConfig {
    ...
    public function __construct() {
        ...
        $this->config = new Config(GeneralSettings::getCloudPath() . "storage/inGame/signLayouts.yml", 2, self::DEFAULT_LAYOUTS);
    }
